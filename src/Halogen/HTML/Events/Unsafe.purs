...
unsafeHandler :: forall fields i. AttributeName -> (Event fields -> EventHandler i) -> Attribute i
unsafeHandler key f = unsafeHandler' key \e -> Just <$> f e

-- | This function can be used to attach custom event handlers.
unsafeHandler' :: forall fields eff i. AttributeName -> (Event fields -> EventHandler (Maybe i)) -> Attribute i

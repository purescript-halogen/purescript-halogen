...
import Halogen.Component.Types (Component, ComponentDSL, unComponent)
...
runUI
  ...
  -> HTMLElement
  -> Aff (HalogenEffects eff) Unit -- (Driver f eff)
runUI component element = do

  let wo :: RenderResult
      wo = unComponent (\c -> (c.render c.initialState).tree)

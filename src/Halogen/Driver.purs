...
runUI component element = _.driver <$> do
  ...
  driver :: AVar (DriverState f eff) -> Driver f eff
  driver ref q = do
  ...
  render :: AVar (DriverState f eff) -> Aff (HalogenEffects eff) Unit
  render ref = do
    ds <- takeVar ref
    if ds.renderPaused
  ...
  flushRender :: AVar (DriverState f eff) -> Aff (HalogenEffects eff) Unit

...
navbar conf = 
  ...
  where
  renderItem :: NavBarItem i -> H.HTML a i
  ...
  renderNavItem :: NavItem i -> H.HTML a i
  renderNavItem (NavLink o) = H.li (if o.active then A.class_ B.active else mempty) [ H.a (target o.target) [H.text o.text] ]
